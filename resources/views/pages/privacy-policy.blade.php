        ...
        <div class="container mx-auto px-2 ">
            <x-card class="sm:p-4 md:p-8">
                <article class="mt-5 prose dark:prose-invert prose-a:text-primary-600 prose-base mx-auto max-w-none">
                    ...
                    <p>At {{ config('app.name') }}, accessible from <a
                            href="{{ route('home') }}">{{ config('app.name') }}</a>, one of
                        our
                        main priorities is the privacy of
                    ...
                    <p>Like any other website, {{ config('app.name') }} uses "cookies". These cookies are used to store
                        information
                    ...
                    <p>Note that {{ config('app.name') }} has no access to or control over these cookies that are used
                        by third-party
                        advertisers.</p>
                    <h2>Third Party Privacy Policies</h2>
                    <p>{{ config('app.name') }}'s Privacy Policy does not apply to other advertisers or websites. Thus,
                        we are advising
                    ...
                    <p>Another part of our priority is adding protection for children while using the internet. We
                        ...
                        online activity. </p>
                    <p>{{ config('app.name') }} does not knowingly collect any Personal Identifiable Information from
                        children under the
