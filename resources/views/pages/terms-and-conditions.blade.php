            ...
            <x-card class="sm:p-4 md:p-8">
                <article class="mt-5 prose dark:prose-invert prose-a:text-primary-600 prose-base mx-auto max-w-none ">
                    ...
                    <p>These terms and conditions outline the rules and regulations for the use of Sourov Tech's
                        Website, located at {{ route('home') }}.</p>
                    ...
                    <p>We employ the use of cookies. By accessing {{ config('app.name') }}, you agreed to use cookies in
                        agreement with
                    ...
                    <p>Unless otherwise stated, Sourov Tech and/or its licensors own the intellectual property rights
                        for all material on {{ config('app.name') }}. All intellectual property rights are reserved. You
                        may access this
                        from {{ config('app.name') }} for your own personal use subjected to restrictions set in these
                        terms and
                        conditions.</p>
                    ...
                    <ul>
                        ...
                        <li>Redistribute content from {{ config('app.name') }}</li>
                    </ul>
