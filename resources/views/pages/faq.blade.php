<x-web-layout>
    ...
    [
        ...
        'a' => "After registering and successfully completing your payment, you will receive a confirmation email with your registration details. You can also check your registration status on the website."
    ],
    [
    ...
    [
        ...
        'a' => 'If you entered incorrect information, please contact our support team immediately at ['.config('mail.from.address').']. Be sure to include your registration details and the correction needed.'
    ],
    [
        'q' => 'Is there a deadline for registration?',
        'a' => 'Yes, the deadline for registration is given on the contest page. Make sure you register and complete your payment by this date to secure your spot in the contest.'
    ],
